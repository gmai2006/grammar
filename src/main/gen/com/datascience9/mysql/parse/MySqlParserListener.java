...
public interface MySqlParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code bindVarExpressionAtom}
	 * labeled alternative in {@link MySqlParser#expressionAtom}.
	 * @param ctx the parse tree
	 */
	void enterBindVarExpressionAtom(MySqlParser.BindVarExpressionAtomContext ctx);
	/**
	 * Exit a parse tree produced by the {@code bindVarExpressionAtom}
	 * labeled alternative in {@link MySqlParser#expressionAtom}.
	 * @param ctx the parse tree
	 */
	void exitBindVarExpressionAtom(MySqlParser.BindVarExpressionAtomContext ctx);
	/**
